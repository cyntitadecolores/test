...
function SociosAprobados() {
  ...
  useEffect(() => {
    axios.get('http://localhost:5001/socio/aprobados')
  ...
  const handleVerMas = (id) => {
    axios.get(`http://localhost:5001/socio/${id}`)
      .then(response => {
        ...
        console.log("Socio seleccionado:", response.data); // útil para validar campos
      })
  ...
  <div className="modal">
    <div className="modal-content">
      ...
      {/* Mostrar detalles según el tipo de socio */}
